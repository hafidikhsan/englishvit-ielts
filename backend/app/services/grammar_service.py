...
class GrammarService:
    ...
    def _evaluate_grammar_sentence_structure(self, grammar_sentence_structures: list) -> float:
        ...
        ev_logger.info(f'Grammar Sentence Structures: {total}')
    ...
    def _generate_feedback(
        ...
        ev_logger.info(f'Grammar Sentence Structures: {total_sentences}')
        ...
        ev_logger.info(f'Grammar Features: {total_features}')
        ...
        try:
            ...
            for sentence in sentences.sents:
                ...
                if len(transcribe_tokens) > 0:
                    ...
                    ev_logger.info(len(transcribe_tokens))
